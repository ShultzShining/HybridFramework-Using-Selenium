...
import com.ecommerce.xls.read.Xls_Reader;
import com.ecommerce.util.SendMail;
...
public class ReportUtil {
    ...
    public static void main(String[] arg) throws Exception {
        ...
        FileInputStream fs = new FileInputStream(System.getProperty("user.dir")+"//src//main//java//com//ecommerce//config//config.properties");
        Properties CONFIG= new Properties();
        CONFIG.load(fs);
        String environment=CONFIG.getProperty("environment");
        String release=CONFIG.getProperty("release");
        Xls_Reader suiteXLS = new Xls_Reader(System.getProperty("user.dir")+"//src//main//java//com//ecommerce//xls//Suite.xlsx");
