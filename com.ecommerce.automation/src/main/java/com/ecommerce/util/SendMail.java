...

{
...

    {
        ...
        String[] to={"note.shashi@gmail.com"};
        ...
        SendMail.sendMail("message.shashi@outlook.com",
                "sakubai01",
                "smtp.msn.com",
                "465",
                "true",
    ...
    public  static boolean sendMail(String userName,
...

        {
            ...
            msg.setFrom(new InternetAddress("message.shashi@outlook.com"));
